          ...
          <section className="my-5 col-lg-10 offset-lg-1">
            <div className="row justify-content-center mb-4">
              <div className="col-lg-7 text-center justify-content-center">
                ...
                <h4 className="mb-3 fw-bold" style={{fontSize:"20px"}}>WE ARE SORRY, PAGE NOT FOUND!</h4>
                <div className="text-uppercase text-sm mb-4 font-weight-light" style={{fontSize:"13px"}}>
