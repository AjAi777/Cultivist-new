  ...
  return (
    <div className='jadoo' style={{ marginTop: '7.5rem' }}>
      ...
      >
        ...
        <h5 className='mt-5 fw-bold'>TERMS OF SERVICE</h5>
        <p>
          This website is operated by Cultivist. Throughout the site, the terms
          “we”, “us” and “our” refer to Cultivist. Cultivist offers this
        ...
        <h6 className='mt-4 fw-bold'>SECTION 1 - ONLINE STORE TERMS</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 2 - GENERAL CONDITIONS</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'> SECTION 5 - PRODUCTS OR SERVICES</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 7 - OPTIONAL TOOLS</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 8 - THIRD-PARTY LINKS</h6>
        <p>
        ...
        <p>
          ...
          (2) To pay compensation for any comments; <br />
        ...
        <h6 className='mt-4 fw-bold'>SECTION 10 - PERSONAL INFORMATION</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 12 - PROHIBITED USES</h6>
        <p>
          In addition to other prohibitions as set forth in the Terms of
          Service, you are prohibited from using the site or its content: <br />{' '}
          (a) for any unlawful purpose; <br /> (b) to solicit others to perform
          or participate in any unlawful acts; <br /> (c) to violate any
          international, federal, provincial or state regulations, rules, laws,
          or local ordinances; <br /> (d) to infringe upon or violate our
          intellectual property rights or the intellectual property rights of
          others; <br /> (e) to harass, abuse, insult, harm, defame, slander,
          disparage, intimidate, or discriminate based on gender, sexual
          orientation, religion, ethnicity, race, age, national origin, or
          disability; <br /> (f) to submit false or misleading information;{' '}
          ...
          website, other websites, or the Internet; <br /> (h) to collect or
          track the personal information of others; <br /> (i) to spam, phish,
          pharm, pretext, spider, crawl, or scrape; <br /> (j) for any obscene
          or immoral purpose; or
          <br /> (k) to interfere with or circumvent the security features of
          the Service or any related website, other websites, or the Internet.{' '}
          <br /> We reserve the right to terminate your use of the Service or
        ...
        <p>
          In no case shall Cultivist, our directors, officers, employees,
        ...
        <h6 className='mt-4 fw-bold'>SECTION 14 - INDEMNIFICATION</h6>
        <p>
          You agree to indemnify, defend and hold harmless Cultivist and our
        ...
        <h6 className='mt-4 fw-bold'>SECTION 15 - SEVERABILITY</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 16 - TERMINATION</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 17 - ENTIRE AGREEMENT</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 18 - GOVERNING LAW</h6>
        <p>
        ...
        <h6 className='mt-4 fw-bold'>SECTION 20 - CONTACT INFORMATION</h6>
        <p className='mb-5'>
